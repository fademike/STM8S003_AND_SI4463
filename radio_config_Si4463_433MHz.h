...
// MOD_type: 3    Rsymb(sps): 10000    Fdev(Hz): 10000    RXBW(Hz): 151000    Manchester: 0    AFC_en: 0    Rsymb_error: 0.0    Chip-Version: 2    
// RF Freq.(MHz): 433.3    API_TC: 29    fhst: 25000    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
// 
// # RX IF frequency is  -468750 Hz
// # WB filter 3 (BW =  61.74 kHz);  NB-filter 3 (BW = 61.74 kHz)
// 
// Modulation index: 2
*/
...
*/
#define RF_MODEM_AFC_GEAR_7 0x11, 0x20, 0x07, 0x2C, 0x04, 0x36, 0x80, 0x1D, 0x0C, 0x01, 0x80
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_9 0x11, 0x20, 0x09, 0x38, 0x11, 0x37, 0x37, 0x00, 0x1A, 0x80, 0x00, 0x00, 0x29
